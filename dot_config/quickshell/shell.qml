                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            PopupWindow {
                                ...
                                implicitWidth: 320
                                implicitHeight: Math.max(160, (rootScope.audioSinks.length * 36) + 130)
                                    ...
                                    ColumnLayout {
                                        ...
                                        Repeater {
                                            ...
                                            Rectangle {
                                                ...
                                                radius: 6
                                                color: sinkItemRect.modelData.isDefault ? "#26233a" : (sinkItemMouse.containsMouse ? "#1f1d2e" : "transparent")
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text {
                                                        font.family: "IoskeleyMono Nerd Font Mono"
                                                        font.pixelSize: 15
                                                        color: sinkItemRect.modelData.isDefault ? "#ebbcba" : "#908caa"
                                                        text: sinkItemRect.modelData.icon
                                                    }
                                                    ...
                                                    Text {
                                                        ...
                                                        font.family: "IoskeleyMono Nerd Font Mono"
                                                        font.pixelSize: 12
                                                        font.bold: sinkItemRect.modelData.isDefault
                                                        color: sinkItemRect.modelData.isDefault ? "#ebbcba" : "#e0def4"
                                                        text: sinkItemRect.modelData.name
                                                        elide: Text.ElideRight
                                                    }

                                                    Text {
                                                        visible: sinkItemRect.modelData.isDefault
                                                        font.family: "IoskeleyMono Nerd Font Mono"
                                                        font.pixelSize: 14
                                                        color: "#ebbcba"
                                                        text: "󰄬"
                                                ...
                                                MouseArea {
                                                    ...
                                                    cursorShape: Qt.PointingHandCursor
                                                    onClicked: {
                                                        audioProc.exec(["wpctl", "set-default", sinkItemRect.modelData.id.toString()])
                                        ...
                                        Rectangle {
                                            ...
                                            radius: 6
                                            color: muteBtnMouse.containsMouse ? "#1f1d2e" : "transparent"
                                            ...
                                            RowLayout {
                                                ...
                                                Text {
                                                    font.family: "IoskeleyMono Nerd Font Mono"
                                                    font.pixelSize: 14
                                                    color: audioMgr.isMuted ? "#eb6f92" : "#9ccfd8"
                                                    text: audioMgr.isMuted ? "󰝟" : "󰕾"
                                                }
                                                ...
                                                Text {
                                                    ...
                                                    font.pixelSize: 11
                                                    color: "#e0def4"
                                                    text: audioMgr.isMuted ? "Unmute Audio" : "Mute Audio"
                                                }
                                            }
                                        ...
                                        // Advanced Settings (Pavucontrol)
                                        Rectangle {
                                            Layout.fillWidth: true
                                            Layout.preferredHeight: 28
                                            radius: 6
                                            color: pavuMouse.containsMouse ? "#1f1d2e" : "transparent"
